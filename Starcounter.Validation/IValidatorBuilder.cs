...
namespace Starcounter.Validation
{
    ...
    public interface IValidatorBuilder
    {
        ...
        /// Further calls to this method will override the previously set <see cref="ErrorPresenter"/>. This method must be called at least once.
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="ErrorPresenter"/> that will be used to present validation errors discovered by validator constructed by this builder.
        /// Further calls to this method will override the previously set <see cref="ErrorPresenter"/>. This method must be called at least once.
        /// </summary>
        /// <param name="errorPresenter">The <see cref="ErrorPresenter"/> to use. It can not be null</param>
        /// <returns>The original builder object</returns>
        /// <remarks>This method changes and returns the original builder object</remarks>
        IValidatorBuilder WithErrorPresenter(ErrorPresenter errorPresenter);
        ...
        /// <summary>
        /// Builds the <see cref="IValidator"/>. If the <see cref="WithErrorPresenter"/> was never 
        /// </summary>
        /// <returns>The new <see cref="IValidator"/> instance.</returns>
        /// <exception cref="InvalidOperationException"><see cref="WithErrorPresenter"/> or <see cref="WithViewModel"/> was never called.</exception>
        IValidator Build();
    }
}